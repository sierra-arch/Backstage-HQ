                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  {founder && (
                    <button
                      ...
                      className="text-xs bg-teal-600 text-white rounded-2xl px-3 py-1.5 hover:bg-teal-700 font-medium"
                    >
                      Add Client
                    </button>
                  )}
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2 pt-2">
                        <button
                          ...
                          className="px-4 py-2 border rounded-2xl hover:bg-neutral-50 text-sm"
                        >
                          Cancel
                        </button>
                        <button
                          ...
                          className="flex-1 bg-teal-600 text-white rounded-2xl px-4 py-2 hover:bg-teal-700 font-medium text-sm disabled:opacity-50"
                        >
                          Add Client
                        </button>
                      </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full mt-1 rounded-2xl border px-3 py-2 text-sm min-h-[90px]"
